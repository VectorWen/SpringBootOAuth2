...
INSERT INTO `user`(id,nickname,phone,avatar,password)
    VALUES ('2', 'vector', '13800138001','/avatar/logo.png','{bcrypt}$2a$10$LDIu79Omb8nAry0bIYv0zOhQYf29YWd/rHNlAvcAW9e0Hi6mJ3bQu');
INSERT INTO `oauth_user_authority`(user_id,authority_id) VALUES ('2', '1'), ('2', '2');
